...
export async function onRequestGet({ env }) {
  try {
    ...
    return json({ ok: true, rev: cfg.rev, status: cfg.status, weights: cfg.weights, serverDraws: cfg.serverDraws, activityStart: cfg.activityStart, participants: st.participants || 0 });
